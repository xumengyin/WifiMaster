...
import com.jerry.wifimaster.wifiutils.wifiConnect.DisconnectCallbackHolder;
import com.jerry.wifimaster.wifiutils.wifiConnect.TimeoutHandler;
import com.jerry.wifimaster.wifiutils.wifiConnect.WifiConnectionCallback;
import com.jerry.wifimaster.wifiutils.wifiConnect.WifiConnectionReceiver;
import com.jerry.wifimaster.wifiutils.wifiDisconnect.DisconnectionErrorCode;
...
import com.jerry.wifimaster.wifiutils.wifiScan.WifiScanCallback;
import com.jerry.wifimaster.wifiutils.wifiScan.WifiScanReceiver;
import com.jerry.wifimaster.wifiutils.wifiState.WifiStateCallback;
import com.jerry.wifimaster.wifiutils.wifiState.WifiStateListener;
import com.jerry.wifimaster.wifiutils.wifiState.WifiStateReceiver;
import com.jerry.wifimaster.wifiutils.wifiWps.ConnectionWpsListener;

import java.util.ArrayList;
import java.util.List;

import static com.jerry.wifimaster.wifiutils.ConnectorUtils.cleanPreviousConfiguration;
import static com.jerry.wifimaster.wifiutils.ConnectorUtils.connectToWifi;
import static com.jerry.wifimaster.wifiutils.ConnectorUtils.connectToWifiHidden;
import static com.jerry.wifimaster.wifiutils.ConnectorUtils.connectWps;
import static com.jerry.wifimaster.wifiutils.ConnectorUtils.disconnectFromWifi;
import static com.jerry.wifimaster.wifiutils.ConnectorUtils.matchScanResult;
import static com.jerry.wifimaster.wifiutils.ConnectorUtils.matchScanResultBssid;
import static com.jerry.wifimaster.wifiutils.ConnectorUtils.matchScanResultSsid;
import static com.jerry.wifimaster.wifiutils.ConnectorUtils.reenableAllHotspots;
import static com.jerry.wifimaster.wifiutils.ConnectorUtils.registerReceiver;
import static com.jerry.wifimaster.wifiutils.ConnectorUtils.removeWifi;
import static com.jerry.wifimaster.wifiutils.ConnectorUtils.unregisterReceiver;
import static com.jerry.wifimaster.wifiutils.utils.VersionUtils.isAndroidQOrLater;
import static com.jerry.wifimaster.wifiutils.utils.VersionUtils.isLollipopOrLater;
...
public final class WifiUtils implements WifiConnectorBuilder,
    ...
    @Override
    public WifiSuccessListener connectWithSingleScan(@NonNull String password, ScanResult result) {
        mSingleScanResult=result;
        mPassword = password;
        return this;
    }
    ...
    public void startConnect() {
        ...
        if(mSingleScanResult!=null&&!mPassword.isEmpty())
        {
            if (connectToWifi(mContext, mWifiManager, mConnectivityManager, mHandler, mSingleScanResult, mPassword, mWifiConnectionCallback)) {
                registerReceiver(mContext, (mWifiConnectionReceiver).connectWith(mSingleScanResult, mPassword, mConnectivityManager),
                        new IntentFilter(WifiManager.SUPPLICANT_STATE_CHANGED_ACTION));
