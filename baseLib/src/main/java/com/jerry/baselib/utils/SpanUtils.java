...
public final class SpanUtils {
    ...
    public static SpanUtils with(final TextView textView,Context context) {
        return new SpanUtils(textView,context);
    }
    ...
    private SpanUtils(TextView textView, Context context) {
        this();
        mTextView = textView;
    ...
    private void updateImage() {
        ...
        if (imageBitmap != null) {
            ...
            mBuilder.setSpan(new CustomImageSpan(imageDrawable, alignImage,context), start, end, flag);
        } else if (imageUri != null) {
            mBuilder.setSpan(new CustomImageSpan(imageUri, alignImage,context), start, end, flag);
        } else if (imageResourceId != -1) {
            mBuilder.setSpan(new CustomImageSpan(imageResourceId, alignImage,context), start, end, flag);
        }
    }
...
//            LogUtils.e(fm, sfm);
    ...
    static class CustomImageSpan extends CustomDynamicDrawableSpan {
        ...
        private CustomImageSpan(final Drawable d, final int verticalAlignment,Context context) {
            super(verticalAlignment);
            this.context=context;
            mDrawable = d;
            mDrawable.setBounds(
        ...
        private CustomImageSpan(final Uri uri, final int verticalAlignment,Context context) {
            super(verticalAlignment);
            this.context=context;
            mContentUri = uri;
        }

        private CustomImageSpan(@DrawableRes final int resourceId, final int verticalAlignment,Context context) {
            super(verticalAlignment);
            this.context=context;
